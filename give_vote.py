...
while True:
    ...
    # Update imgBackground with the new frame
    frame = cv2.resize(frame, (431, 431))  # Resize frame to match height of imgBackground
    imgBackground[0:431, 0:431] = frame  # Place frame on the left side of imgBackground
